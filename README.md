# SIMS SMAN 1 Gianyar - Sistem Informasi Manajemen Sekolah

Sistem Informasi Manajemen Sekolah (SIMS) SMAN 1 Gianyar berbasis Laravel 11 (Backend & Filament Admin Dashboard) dan Flutter (Aplikasi Mobile Siswa & Guru).
...
- **Backend:** PHP 8.2+, Laravel 11, Filament v3, Livewire
- **Database:** MySQL
- **Mobile:** Flutter / Dart
- **Server Production:** Ubuntu Linux / Nginx / SSL

## 📄 Lisensi
Hak Cipta © SMAN 1 Gianyar.
