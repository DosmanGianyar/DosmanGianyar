...
class GuruLayananTest extends TestCase
{
    ...
    public function test_guru_can_access_layanan_page_and_api()
    {
        ...
        SchoolClass::create(['name' => 'X MIPA 1', 'grade' => 'X', 'homeroom_teacher_id' => $wali->id]);
        ...
        // API Endpoint Test
        $apiResponse = $this->actingAs($guru, 'sanctum')->withHeaders(['X-Device-ID' => 'test-device'])->getJson('/api/v1/guru/layanan');
