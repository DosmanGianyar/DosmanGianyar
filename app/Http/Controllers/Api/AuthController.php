...
class AuthController extends Controller
{
    ...
    private function userPayload(User $user): array
    {
        ...
        return [
            ...
            'child_order'          => $user->child_order,
            'siblings_count'       => $user->siblings_count,
            'step_siblings_count'  => $user->step_siblings_count,
            'foster_siblings_count'=> $user->foster_siblings_count,
            'orphan_status'        => $user->orphan_status,
            'daily_language'       => $user->daily_language,
            'gender'               => $user->gender,
            'address'              => $user->address,
            'living_with'          => $user->living_with,
            ...
            'father_birth_place'   => $user->father_birth_place,
            'father_birth_date'    => $user->father_birth_date?->toDateString(),
            'father_religion'      => $user->father_religion,
            'father_citizenship'   => $user->father_citizenship,
            'father_education'     => $user->father_education,
            'father_phone'         => $user->father_phone,
            'father_job'           => $user->father_job,
            'father_income'        => $user->father_income,
            'father_address'       => $user->father_address,
            'father_status'        => $user->father_status,
            'mother_name'          => $user->mother_name,
            'mother_birth_place'   => $user->mother_birth_place,
            'mother_birth_date'    => $user->mother_birth_date?->toDateString(),
            'mother_religion'      => $user->mother_religion,
            'mother_citizenship'   => $user->mother_citizenship,
            'mother_education'     => $user->mother_education,
            'mother_phone'         => $user->mother_phone,
            'mother_job'           => $user->mother_job,
            'mother_income'        => $user->mother_income,
            'mother_address'       => $user->mother_address,
            'mother_status'        => $user->mother_status,
            'guardian_name'        => $user->guardian_name,
            'guardian_birth_place' => $user->guardian_birth_place,
            'guardian_birth_date'  => $user->guardian_birth_date?->toDateString(),
            'guardian_religion'    => $user->guardian_religion,
            'guardian_citizenship' => $user->guardian_citizenship,
            'guardian_education'   => $user->guardian_education,
            'guardian_phone'       => $user->guardian_phone,
            'guardian_job'         => $user->guardian_job,
            'guardian_income'      => $user->guardian_income,
            ...
            'physical_disability'  => $user->physical_disability,
            'height_cm'            => $user->height_cm,
            'weight_kg'            => $user->weight_kg,
            'prev_school_name'     => $user->prev_school_name,
            'prev_sttb_no'         => $user->prev_sttb_no,
            'prev_sttb_date'       => $user->prev_sttb_date?->toDateString(),
            'prev_study_duration'  => $user->prev_study_duration,
            'transfer_from_school' => $user->transfer_from_school,
            'transfer_reason'      => $user->transfer_reason,
            'admission_grade'      => $user->admission_grade,
            'admission_class_group'=> $user->admission_class_group,
            'admission_major'      => $user->admission_major,
