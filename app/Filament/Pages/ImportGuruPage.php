...
class ImportGuruPage extends Page
{
    ...
    protected string $view = 'filament.pages.import-guru';
    ...
    public function startImport(): void
    {
        ...
        $collector = new class extends GuruImport {
        ...
        if ($headerIndex === null) {
            Notification::make()
                ...
                ->body('Pastikan file memiliki kolom NIP.')
                ->danger()
                ->send();
            return;
        }
