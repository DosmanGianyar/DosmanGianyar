    ...
    <div class="lg:col-span-1">
        <div class="bg-white border border-gray-100 rounded-3xl p-5 shadow-sm space-y-4">
            ...
            <form action="{{ route('siswa.library.store') }}" method="POST" class="space-y-3 text-xs">
                ...
                <div>
                    <label class="block font-bold text-gray-700 mb-1">No. HP / WhatsApp Peminjam <span class="text-red-500">*</span></label>
                    <input type="tel" name="phone_number" value="{{ old('phone_number', $siswa->phone ?? '') }}" required
