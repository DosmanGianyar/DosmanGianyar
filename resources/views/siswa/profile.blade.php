...
<div class="space-y-4">
    ...
    <div id="ganti-password" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
        ...
        <form method="POST" action="{{ route('siswa.profile.password') }}" class="space-y-3">
            ...
            <button type="submit"
                class="w-full py-2.5 bg-[#0a3880] hover:bg-[#1565c0] text-white text-sm font-bold rounded-xl shadow-xs active:scale-[0.99] transition-all flex items-center justify-center gap-1.5">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
