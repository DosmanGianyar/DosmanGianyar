...
{{-- ─── Header ───────────────────────────────────────────────────────── --}}
<div class="rounded-2xl p-4 mb-4 text-white shadow-md" style="background: linear-gradient(135deg, #059669 0%, #0d9488 100%) !important; color: #ffffff !important;">
...
{{-- ─── Guru Wali Card ─────────────────────────────────────────────── --}}
@if($guruWali)
<div class="flex items-center gap-3 bg-indigo-50 border border-indigo-100 rounded-2xl p-4 mb-4">
    ...
    <div class="flex-1 min-w-0">
        <p class="text-xs font-semibold text-indigo-500">Guru Wali Kamu</p>
        <p class="text-sm font-bold text-indigo-800 truncate">{{ $guruWali->name }}</p>
        @if($guruWali->subject)
        <p class="text-xs text-indigo-400 truncate">{{ $guruWali->subject }}</p>
        @endif
    </div>
    <a href="{{ route('siswa.homeroom-consultation.index') }}"
        class="shrink-0 text-xs font-semibold text-indigo-600 hover:text-indigo-800 flex items-center gap-0.5">
        Bimbingan
...
@else
<div class="flex items-center gap-3 bg-gray-50 border border-gray-100 rounded-2xl p-4 mb-4">
    ...
    <div>
        <p class="text-xs text-gray-400 font-semibold">Guru Wali</p>
        <p class="text-sm text-gray-400">Belum memiliki Guru Wali</p>
    </div>
</div>
@endif

{{-- ─── Bimbingan Guru Wali Shortcut ─────────────────────────────── --}}
<a href="{{ route('siswa.homeroom-consultation.index') }}"
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <p class="text-sm font-semibold text-gray-800">Bimbingan Guru Wali</p>
