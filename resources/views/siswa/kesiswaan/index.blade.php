...
{{-- ─── Tata Tertib Sekolah Card ────────────────────────────────────── --}}
<a href="{{ route('siswa.tata-tertib') }}"
    class="flex items-center justify-between bg-white rounded-2xl shadow-sm border border-blue-100 p-4 mb-4 hover:border-blue-300 transition-colors">
    <div class="flex items-center gap-3">
        ...
        <div class="flex-1 min-w-0">
            <p class="text-sm font-semibold text-gray-800">Tata Tertib Sekolah</p>
            <p class="text-xs text-blue-600 font-medium mt-0.5">Aturan, Hak, Kewajiban & Seragam SMAN 1 Gianyar</p>
        </div>
    </div>
    <div class="flex items-center gap-1.5 shrink-0">
        <span class="text-xs font-bold text-blue-700 bg-blue-50 border border-blue-200 px-2.5 py-0.5 rounded-full">
            PDF & Web
        </span>
        <svg class="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
