...
<a href="{{ route('siswa.tata-tertib') }}"
    class="flex items-center justify-between bg-white rounded-2xl shadow-sm border border-blue-100 p-3.5 sm:p-4 mb-3.5 hover:border-blue-300 transition-all group overflow-hidden box-border">
    <div class="flex items-center gap-2.5 sm:gap-3 min-w-0 flex-1 pr-2">
        <div class="w-9 h-9 sm:w-10 sm:h-10 bg-blue-100 rounded-xl flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
        ...
        <div class="flex-1 min-w-0">
            <div class="flex items-center gap-1.5 flex-wrap">
                <p class="text-xs sm:text-sm font-bold text-gray-800 truncate">Tata Tertib Sekolah</p>
                <span class="text-[9px] sm:text-[10px] font-extrabold bg-blue-50 text-blue-700 border border-blue-200 px-1.5 py-0.2 rounded-full shrink-0">Resmi</span>
            </div>
            <p class="text-[11px] sm:text-xs text-gray-500 mt-0.5 truncate">Aturan, Hak, Kewajiban & Seragam SMAN 1 Gianyar</p>
        </div>
    </div>
    <div class="shrink-0">
        <span class="px-2.5 py-1 bg-blue-50 border border-blue-200/60 text-blue-600 rounded-xl text-xs font-bold shrink-0 flex items-center gap-0.5 group-hover:bg-blue-600 group-hover:text-white transition-all">
            Buka <span class="group-hover:translate-x-0.5 transition-transform">→</span>
        </span>
    </div>
</a>
