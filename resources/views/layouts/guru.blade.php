        ...
        @php
            $navGroups = [
                ...
                [
                    ...
                    'items' => [
                        ['route' => 'guru.tp.index',                    'label' => 'Tujuan Pembelajaran', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7l-3 3m0 0l-3-3m3 3V8'],
                        ...
                        ['route' => 'guru.homeroom-consultation.index', 'label' => 'Jurnal Bimbingan Guru Wali',  'icon' => 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z'],
                    ],
                ],
                [
                    ...
                    'items' => [
                        ['route' => 'guru.bk.index', 'label' => 'Catatan BK', 'icon' => 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z'],
                    ],
                ],
                [
                    ...
                    'items' => [
                        ['route' => 'guru.sarpras.index', 'label' => 'Inventaris & Peminjaman', 'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4'],
                    ],
                ],
                [
                    'label' => 'Laporan',
                    ...
                    'items' => [
                        ['route' => 'guru.attendance.rekap',       'label' => 'Rekap Absensi',   'icon' => 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
                        ['route' => 'guru.export.attendance.form', 'label' => 'Export Absensi',  'icon' => 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4'],
                    ],
                ],
                [
                    'label' => 'Akun',
