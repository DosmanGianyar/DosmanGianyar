...
class SchoolRegulationSeeder extends Seeder
{
    ...
    {
        // ── Tata Tertib Resmi SMA Negeri 1 Gianyar (Literal Verbatim dari PDF Scan TataTertib SIswa.pdf) ──
        $regulations = [
            ...
            [
                'category'   => 'kbm',
                'sort_order' => 4,
                'title'      => 'B. Kegiatan Belajar Mengajar',
                'content'    => "1. Sebelum kegiatan belajar mengajar dimulai, piket kelas menyiapkan sarana pembelajaran yang dibutuhkan dengan berkoordinasi terlebih dahulu dengan guru mata pelajaran.\n2. Setiap mengawali pelajaran Peserta Didik wajib mengucapkan salam (Panganjali Umat) dan doa, serta mengakhiri dengan doa dan mengucapkan salam (Paramasanthi).\n3. Mengikuti keseluruhan kegiatan belajar mengajar sejak jam pertama hingga jam terakhir, serta pulang secara bersama-sama setelah tanda bel pelajaran terakhir berbunyi.\n4. Peserta Didik tidak diperkenankan meninggalkan kelas saat pembelajaran sedang berlangsung kecuali mendapat izin dari guru pengajar, dan tidak diperkenankan meninggalkan halaman sekolah, kecuali seizin wali kelas atau guru piket.\n5. Jika 10 (sepuluh) menit setelah bel berbunyi guru belum hadir, maka ketua kelas atau pengurus kelas wajib menghubungi guru bersangkutan atau menanyakan kepada guru piket. Bila guru berhalangan hadir, Peserta Didik wajib mengerjakan Tugu yang diberikan sesuai dengan petunjuk.\n6. Sesudah KBM berakhir, Peserta Didik wajib membersihkan ruang kelas serta mematikan semua alat elektronik yang ada di kelas dan meninggalkan ruang kelas dengan tertib."
            ],
            ...
            [
                'category'   => 'kbm',
                'sort_order' => 5,
                'title'      => 'C. Waktu Belajar',
                'content'    => "1. Memenuhi kehadiran di sekolah sekurang-kurangnya 90% dari hari efektif sekolah selama satu semester.\n2. Peserta Didik tidak diperkenankan memajukan mata pelajaran yang tidak sesuai dengan jadwal.\n3. Pelaksanaan ekstrakurikuler maksimal sampai pukul 18.30 WITA di sekolah dan apabila melebihi waktu yang telah ditentukan harus mendapat izin dari pembina ekstra atau pembina kesiswaan."
            ],
